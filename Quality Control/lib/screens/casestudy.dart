...
class casestudy extends StatefulWidget {
  const casestudy({super.key, required this.titlereview});
...
Future<void> _uploadData() async {
  if (_image != null) {
    ...
    // 'titlereview', 'image_url' ve 'timestamp' dahil verileri Firestore'a kaydetme
    ...
    return Column(
      children: [
        _image != null
            ...
            : const Text('Henüz fotoğraf seçmediniz.'),
        const SizedBox(height: 20),
        ElevatedButton(
